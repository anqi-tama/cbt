...
import { ExamSession, ExamState, QuestionType } from '../../shared/types';
...
const ExamView: React.FC<ExamViewProps> = ({ exam, state, updateAnswer, lang, onLangChange, onFinish }) => {
    ...
    <div className="fixed inset-0 bg-slate-50 flex flex-col overflow-hidden z-50">
      ...
      <header className="bg-slate-900 text-white px-6 py-4 flex items-center justify-between shadow-lg">
        ...
        <div className="flex items-center gap-8">
          {/* Language selection inside secure environment */}
          ...
          <aside className="w-80 bg-white border-r border-slate-200 overflow-y-auto p-4 flex flex-col gap-4">
            ...
            <div className="mt-auto border-t pt-4 space-y-2">
              <div className="flex items-center gap-2 text-xs font-medium text-slate-500">
                ...
                <span>{t.participant.answered}</span>
              </div>
              <div className="flex items-center gap-2 text-xs font-medium text-slate-500">
                <div className="w-3 h-3 rounded-sm bg-slate-100" />
                <span>{t.participant.notAnswered}</span>
              </div>
              <div className="flex items-center gap-2 text-xs font-medium text-slate-500">
